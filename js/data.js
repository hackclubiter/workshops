const workshopData = [
  ...
  {
    workshopName: "Hack the October Fest 2021",
    about: "A month long event keeping in view Hacktoberfest 2021.", //About the workshop in about 50 words
    link: "https://hacktheoctober.hackclub.com/", //enter the link of the workshop
    image:
    ...
    time: "12am Onwards", //give the event's time
  },
...
const pastWorkshopData = [
  {
    ...
    about:
      "Build your first project with Arduino Uno and we will help in Hardware.", //About the workshop in about 50 words
    link: "#", //enter the link of the workshop
    image:
      "https://images.unsplash.com/photo-1559819614-81fea9efd090?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1350&q=80", //give the image (make sure to host it before adding)
    date: "15 Sep 2021", //give the event's date
    time: "7 PM Onwards", //give the event's time
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1577113398331-d843d3341a63?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=667&q=80", //give the image (make sure to host it before adding)
